...
:: Gui email thong bao cho subscriber
echo [Agri Blog] Dang gui email thong bao cho subscriber...
node scripts/send_post_notification.js

:: Commit va push bai viet moi len GitHub (kich hoat Vercel auto deployment)
echo [Agri Blog] Dang commit va push bai viet moi len GitHub...
git add _posts/ _data/
git commit -m "auto: publish daily post %date%"
