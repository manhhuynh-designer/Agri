...
Để tránh làm xao nhãng người đọc khi theo dõi nội dung kỹ thuật:
- **Trong thân bài viết:** Các thông tin cần dẫn chứng nguồn bắt buộc phải được đánh số thứ tự tăng dần trong ngoặc vuông (ví dụ: `[1]`, `[2]`, `[3]`...). Tuyệt đối không ghi trực tiếp tên tài liệu hay tác giả trong các đoạn văn của thân bài.
- **Cuối mỗi bài viết:** Tạo mục `### Tài liệu trích dẫn chi tiết` liệt kê đầy đủ nguồn gốc tương ứng với các số thứ tự trên theo định dạng:
  - `[1] Tên tài liệu, Tác giả, Chương, Trang.`
  - `[2] Tên tài liệu, Tác giả, Chương, Trang.`

*Ví dụ:*
- **Trong thân bài:** "...nhằm duy trì mật độ của các loài gây hại ở dưới mức gây ra những thiệt hại kinh tế [1]."
- **Phần cuối bài:**
  ```markdown
  ### Tài liệu trích dẫn chi tiết
  - `[1]` *Kỹ thuật bảo vệ thực vật*, PGS. TS. Phạm Văn Lầm, Chương 10, Trang 180.
  - `[2]` *Giáo trình Nông nghiệp hữu cơ*, GS. TS. Nguyễn Thế Đặng, Chương 3, Trang 41.
  ```
