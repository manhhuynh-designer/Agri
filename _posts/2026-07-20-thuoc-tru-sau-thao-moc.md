...
<div class="mermaid">
graph TD
    A[Bắt đầu: Tự chế thuốc trừ sâu thảo mộc an toàn] --> B[Lựa chọn nguyên liệu thảo mộc]
    
    subgraph "Nguyên liệu phổ biến [1-3]"
        B1[Nhóm mùi hăng: Tỏi, ớt, gừng, hành]
        B2[Nhóm độc tố tự nhiên: Lá/hạt xoan, rễ dây mật, cây ruốc cá]
        B3[Nhóm hoa/thảo dược: Cúc vạn thọ, cúc trừ trùng, rau thơm]
    end
    ...
    B1 --> C[Sơ chế: Nghiền, giã nát hoặc băm nhỏ khúc 20-30cm [2, 4]]
    B2 --> C
    B3 --> C

    C --> D{Phương pháp chiết xuất [5, 6]}
    D --> D1[Ngâm nguyên liệu trong nước ít nhất 12-24 giờ]
    D --> D2[Nghiền nát trực tiếp cùng với nước sạch]

    D1 --> E[Lọc lấy nước dịch chiết qua vải màn hoặc lưới lọc [2, 7]]
    D2 --> E

    E --> F[Pha loãng dung dịch cô đặc với nước sạch [6]]
    
    F --> G[Sử dụng: Phun trực tiếp lên cây bị sâu bệnh phá hoại [3, 8]]

    G --> H[Lưu ý an toàn & Hiệu quả [9-11]]
    H --> H1[Trang bị bảo hộ: Khẩu trang, găng tay, kính bảo vệ mắt]
    H --> H2[Không dùng thuốc lá/nicotin vì rất độc cho người và thiên địch]
    H --> H3[Nên phun vào sáng sớm hoặc chiều mát khi lặng gió]
    H --> H4[Thử nghiệm trên diện tích nhỏ trước khi phun đại trà]
</div>
</div>
