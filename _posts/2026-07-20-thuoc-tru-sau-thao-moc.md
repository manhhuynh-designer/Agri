...
image: https://images.pexels.com/photos/32681817/pexels-photo-32681817.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940
...
<svg viewBox="0 0 640 260" width="100%" height="auto" class="diagram-svg" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="320" y="30" text-anchor="middle" class="d-label-title">QUY TRÌNH CHẾ BIẾN THUỐC TRỪ SÂU THẢO MỘC</text>
  
  <!-- Boxes -->
  <rect x="20" y="70" width="130" height="50" rx="5" class="d-line" fill="none" />
  <text x="85" y="100" text-anchor="middle" class="d-label">NGUYÊN LIỆU</text>
  
  <rect x="180" y="70" width="130" height="50" rx="5" class="d-line" fill="none" />
  <text x="245" y="100" text-anchor="middle" class="d-label">GIÃ NHỎ / NGHIỀN</text>
  
  <rect x="340" y="70" width="130" height="50" rx="5" class="d-line" fill="none" />
  <text x="405" y="100" text-anchor="middle" class="d-label">NGÂM CHIẾT</text>
  
  <rect x="500" y="70" width="120" height="50" rx="5" class="d-line" fill="none" />
  <text x="560" y="100" text-anchor="middle" class="d-label">LỌC DỊCH CHIẾT</text>
  
  <rect x="260" y="170" width="140" height="50" rx="5" class="d-line-em" fill="none" />
  <text x="330" y="200" text-anchor="middle" class="d-label-em">PHA LOÃNG & PHUN</text>

  <!-- Arrows -->
  <line x1="150" y1="95" x2="175" y2="95" class="d-line" marker-end="url(#arrow)" />
  <line x1="310" y1="95" x2="335" y2="95" class="d-line" marker-end="url(#arrow)" />
  <line x1="470" y1="95" x2="495" y2="95" class="d-line" marker-end="url(#arrow)" />
  
  <!-- Path to Application -->
  <path d="M560 120 L560 195 L405 195" class="d-ember-dash" fill="none" marker-end="url(#arrow)" />
  
  <!-- Annotations -->
  <line x1="405" y1="120" x2="405" y2="150" class="d-leader" />
  <text x="405" y="165" text-anchor="middle" class="d-label">Ngâm 12 - 24 giờ</text>
</svg>
</div>
